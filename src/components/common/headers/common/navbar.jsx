            ...
            <li className={`menu-item`} key={key}>
                ...
                {hasSub ?
                    <ul className="sub-menu">
                        {menu.children.map((_menu, _key) => 
                            {
                                if(_menu.name == "Schwab Login"){
                                    return <a href='https://client.schwab.com/Login/SignOn/CustomerCenterLogin.aspx?&kc=y&sim=y'>Schwab Login</a>
                                }else{
                           return this.menuRender(_menu, _menu.name, _key)
                                }
                            }

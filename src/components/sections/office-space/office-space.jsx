                ...
                <div className="row">
                    <div className="col-lg-6 col-md-12 col-sm-12 align-self-center pb-maxmd">
                        <div className="w-lg-75 mx-auto">
                            ...
                            <h2 className="text-uppercase mb-4">Lorem, ipsum.</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero sunt, aperiam quibusdam numquam est aliquam laboriosam eaque itaque commodi deserunt consectetur quo qui enim recusandae quia beatae. Quae, eum numquam!</p>
                            <PopupVideo
                                title="Watch Video"
                            >
                            </PopupVideo>
